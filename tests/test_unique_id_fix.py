...
from custom_components.portainer.sensor import EndpointSensor
...
class TestUniqueIdGeneration:
    ...
    def test_endpoints_with_same_name_different_ids(
        self, coordinator, endpoints_description
    ):
    ...
    def test_endpoint_missing_name_uses_unknown(
        self, coordinator, endpoints_description
    ):
    ...
    def test_error_scenario_reproduction(self, coordinator, endpoints_description):
        ...
        old_problematic_format = (
            "test-portainer-endpoints-primary01jzj6vmef68emftp5vwhrhg63"
        )
        ...
        expected_format = (
            "test-portainer-endpoints-1_primary_test_entry_01jzj6vmef68emftp5vwhrhg63"
        )
