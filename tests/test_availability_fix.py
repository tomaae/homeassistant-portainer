...
class TestEntityAvailabilityFix:
    ...
    @pytest.fixture
    def mock_config_entry_no_options(self):
    ...
    @pytest.fixture
    def mock_config_entry_feature_enabled(self):
    ...
    @pytest.fixture
    def mock_config_entry_feature_disabled(self):
    ...
    def coordinator_base(self):
        ...
        coordinator.data = {
            "system": {
                "next_update_check": "2025-07-07T10:00:00Z"
            }
        }
        return coordinator
    ...
    def test_button_enabled_default_new_integration(self, coordinator_base, mock_config_entry_no_options):
        ...
        button = ForceUpdateCheckButton(coordinator_base, mock_config_entry_no_options.entry_id)
    ...
    def test_button_enabled_default_feature_enabled(self, coordinator_base, mock_config_entry_feature_enabled):
        """Test button is enabled by default when feature is enabled."""
        coordinator_base.config_entry = mock_config_entry_feature_enabled
        
        button = ForceUpdateCheckButton(coordinator_base, mock_config_entry_feature_enabled.entry_id)
        
        # Should be enabled by default
        assert button._attr_entity_registry_enabled_default is True

    def test_button_enabled_default_feature_disabled(self, coordinator_base, mock_config_entry_feature_disabled):
        ...
        button = ForceUpdateCheckButton(coordinator_base, mock_config_entry_feature_disabled.entry_id)
    ...
    def test_button_availability_no_options(self, coordinator_base, mock_config_entry_no_options):
    ...
    def test_button_availability_feature_enabled(self, coordinator_base, mock_config_entry_feature_enabled):
    ...
    def test_button_availability_feature_disabled(self, coordinator_base, mock_config_entry_feature_disabled):
    ...
    def test_sensor_enabled_default_new_integration(self, coordinator_base, mock_config_entry_no_options, update_check_description):
    ...
    def test_sensor_enabled_default_feature_enabled(self, coordinator_base, mock_config_entry_feature_enabled, update_check_description):
    ...
    def test_sensor_enabled_default_feature_disabled(self, coordinator_base, mock_config_entry_feature_disabled, update_check_description):
    ...
    def test_sensor_availability_no_options(self, coordinator_base, mock_config_entry_no_options, update_check_description):
    ...
    def test_sensor_availability_feature_enabled(self, coordinator_base, mock_config_entry_feature_enabled, update_check_description):
    ...
    def test_sensor_availability_feature_disabled(self, coordinator_base, mock_config_entry_feature_disabled, update_check_description):
